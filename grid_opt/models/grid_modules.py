...
class FeatureGridBase(torch.nn.Module):
    """
    Base class for 2D/3D feature grids.
    
    It defines the basic properties and methods that all feature grids should have.
    """
...
class BasisVM(torch.nn.Module):
    """Basis module for VM factorization feature grid."""
